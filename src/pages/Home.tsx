              ...
              <div className="grid grid-cols-4 md:grid-cols-10 gap-x-2 gap-y-4 pt-2">
                {dbCategories.map((cat) => {
                  return (
                    ...
                    >
                      <div className={`w-[52px] h-[52px] md:w-[60px] md:h-[60px] bg-white rounded-2xl flex items-center justify-center mb-2 shadow-sm border border-gray-100 group-hover:-translate-y-1 transition transform duration-200 overflow-hidden ${
                        categoryQuery === cat.slug ? 'ring-2 ring-primary border-primary' : 'group-hover:border-primary/50 group-hover:shadow-md'
                      }`}>
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            (e.target as HTMLImageElement).src = 'https://placehold.co/100x100/f3f4f6/a1a1aa?text=Icon';
                          }}
                        />
                      </div>
